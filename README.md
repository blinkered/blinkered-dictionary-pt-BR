# Blinkered dictionary: Brazilian Portuguese

The Brazilian Portuguese word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Brazilian Portuguese.

**153,146 of 200,241 candidates proved — 76.5%**, across 7 independent
families, 5 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Brazilian Portuguese, and why those
...
Candidates come from Blinkered's Brazilian Portuguese list, which lives in
[`blinkered-attestation/candidates/pt-BR`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/pt-BR).
